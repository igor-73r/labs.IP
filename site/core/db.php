...
class DB {
    ...
    private  function __construct() {
        $this->connect = mysqli_connect("localhost", "root", "root") or die("Невозможно установить соединение".mysqli_error($this->connect));
        mysqli_select_db($this->connect, "site_db") or die ("Невозможно выбрать указанную базу".mysqli_error($this->connect));
